...
internal class Program
{
    private static void Main(string[] args)
    {
        ...
        // Creo jugadores
        Jugador jugador1 = new Jugador(123, "Lionel Messi", 100, 75);
        Jugador jugador2 = new Jugador(456, "Cristiano Ronaldo", 120, 96);
        Jugador jugador3 = new Jugador(789, "Neymar Jr.", 80, 48);
        Jugador jugador4 = new Jugador(123, "Lionel Messi", 150, 165); // Mismo DNI que jugador1, no debería agregarse

        DirectorTecnico d1 = new DirectorTecnico("Pep Guardiola", new DateTime(1971, 1, 18));
        Console.WriteLine("Director Técnico creado:");
        ...
        Jugador jugadorExtra = new Jugador(999, "Mbappé", 70, 46);
