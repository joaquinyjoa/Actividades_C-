...
namespace Carrera
{
    public class Competencia
    {
        ...
        public static bool operator ==(Competencia c, VehiculoDeCarrera a) 
        {
            ...
            string mensaje = "El vehículo no corresponde a la competencia";
            ...
            try 
            {
                ...
                {
                    throw new CompetenciaNoDisponibleException(mensaje, tipo, "==");
                }
            }
            finally 
            {
        ...
        {
            bool agregado = false;
            string mensaje = "Competencia incorrecta";
            string tipo = c.Tipo.ToString();
            ...
            {
                throw new CompetenciaNoDisponibleException(mensaje, tipo, "+", e);
            }
