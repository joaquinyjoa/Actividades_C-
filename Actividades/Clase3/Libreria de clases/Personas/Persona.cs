...
namespace Personas
{
    public class Persona
    {
        ...
        public string Mostrar()
        {
            ...
            mensaje.AppendLine($"La fecha de nacimiento del usuario es: {FechaDeNacimiento}");
        ...
        public string EsMayorDeEdad(string usuarioUno, int edadUno, string usuarioDos, int edadDos)
        {
            StringBuilder mensaje = new StringBuilder();

            if (edadUno > edadDos)
            {
                mensaje.Append($"{usuarioUno} es mayor que {usuarioDos}");
            }
            else
            {
                mensaje.Append($"{usuarioDos} es mayor que {usuarioUno}");
            }
